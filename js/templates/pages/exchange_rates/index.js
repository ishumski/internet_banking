...
<div class="exchange__rates-wrapper">
    ...
    <div class="currency__convertor"> 
        <div class="BYN curr-input">
            <input id="BYN" type="number" min="0" max="10000">
        ...
        <div class="USD curr-input">
            <input id="USD" type="number" min="0" max="10000">
            <span class="curr-info">
        ...
        <div class="EUR curr-input">
            <input id="EUR" type="number" min="0" max="10000">
            <span class="curr-info">
        ...
        <div class="PLN curr-input">
            <input id="PLN" type="number" min="0" max="10000">
            <span class="curr-info">
        ...
        <div class="RUB curr-input">
            <input id="RUB" type="number" min="0" max="10000">
            <span class="curr-info">
        ...
        <div class="GBP curr-input">
            <input id="GBP" type="number" min="0" max="10000">
            <span class="curr-info">
